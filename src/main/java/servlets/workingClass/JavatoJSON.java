...
import servlets.jsonClasses.JsonArray;
import servlets.jsonClasses.JsonFloat;
import servlets.jsonClasses.JsonInt;
import servlets.jsonClasses.JsonKeyWord;
import servlets.jsonClasses.JsonNummber;
import servlets.jsonClasses.JsonObject;
import servlets.jsonClasses.JsonString;
import servlets.jsonClasses.JsonValue;
...
public class JavatoJSON {
	...
	private Map<Integer, JsonValue> used = new HashMap<Integer, JsonValue>();
	...
	// Methode die den Objekttyp bestimmt und dieses an die entsprechende
	// Methode weitergiebt
	@SuppressWarnings("unchecked")
	...
	private JsonObject handleComplexTypes(Object obj) throws Throwable {
		...
		for (Method method : methods) {
			if (method.getName().startsWith("get") && method.getParameterTypes().length == 0
					&& method.getReturnType() != void.class && method.getName() != "getClass") {
				getters.add(method);
			}
		}
	...
	private JsonKeyWord handleBoolean(Object obj) {
	...
	private JsonNummber handleNummbers(Object obj) throws Throwable {
		...
		if (INTEGERS.contains(obj.getClass()))
			...
			jsonNumber = addtoRegistered(obj, new JsonFloat((Double) obj));
		else
